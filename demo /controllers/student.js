...
// This code will run when i will run the server
// ata api key chara kaj korche karon env file cloudkey ache oikhan thke pache alada kore config korte hochena
// cloudinary.uploader.upload("uploads/61ce1f021e4be038945c5c3b.jpg",{
//   use_filename:true,
  ...
  try {
    ...
    Promise.all(uploadPromises)
      .then(async (profileimg) => {
        ...
        const StudentImage = await Student.create({
          profile: profileimg
        });
